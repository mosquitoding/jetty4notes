...
public class ManagedSelector extends ContainerLifeCycle implements Dumpable
{
    ...
    public void submit(SelectorUpdate update)
    {
        ...
        {
            _updates.offer(update);//为什么要使用dequeue?
    ...
    {//by djw
        EndPoint endPoint = _selectorManager.newEndPoint(channel, this, selectionKey);//SocketChannelEndpoint
        Connection connection = _selectorManager.newConnection(channel, endPoint, selectionKey.attachment());//SslConnection
        endPoint.setConnection(connection);
        selectionKey.attach(endPoint);
        endPoint.onOpen();// IdleTimeout:checkIdleTimeout:156
